    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        ...
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
            <div class="logo-container">
                <div class="logo-wrapper">
                    <img src="{{asset('assets/img/Golden-petcare.png')}}" alt="main_logo">
                </div>
                <span class="logo-text ms-2 font-weight-bold">Golden Pet Care</span>
            </div>
            ...
            <style>
                ...
                /* Pembungkus untuk memastikan lingkaran */
                .logo-wrapper {
                    width: 50px; /* Lebar pembungkus gambar */
                    height: 50px; /* Tinggi pembungkus gambar */
                    border-radius: 50%; /* Membuat gambar bulat */
                    overflow: hidden; /* Memastikan isi tetap dalam lingkaran */
                    border: 2px solid #ccc; /* Opsional: Bingkai */
                    display: flex;
                ...
                .logo-wrapper img {
                    width: 100%; /* Gambar menyesuaikan lebar pembungkus */
                    height: auto; /* Hindari distorsi */
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link  " href="../pages/virtual-reality.html">
              ...
              <span class="nav-link-text ms-1">Kandang</span>
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item mt-3">
            <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Reservasi pages</h6>
          </li>
          <li class="nav-item">
            <a class="nav-link  " href="../pages/profile.html">
              ...
              <span class="nav-link-text ms-1">Peliharaan</span>
            </a>
          </li>
          <li class="nav-item">
      ...
      <div class="sidenav-footer mx-3 ">
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
          <div class="full-background" style="background-image: url('{{asset ('assets/img/Golden-petcare.png')}}"></div>
